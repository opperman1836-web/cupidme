...
export async function createDuel(req: AuthRequest, res: any, next: any) {
  try {
...
export async function startDuel(req: AuthRequest, res: any, next: any) {
  try {
...
export async function answerDuel(req: AuthRequest, res: any, next: any) {
  try {
...
export async function completeDuel(req: AuthRequest, res: any, next: any) {
  try {
...
export async function getDuel(req: AuthRequest, res: any, next: any) {
  try {
...
export async function getUserDuels(req: AuthRequest, res: any, next: any) {
  try {
...
export async function getCredits(req: AuthRequest, res: any, next: any) {
  try {
...
export async function claimFreeCredit(req: AuthRequest, res: any, next: any) {
  try {
...
export async function purchaseCredits(req: AuthRequest, res: any, next: any) {
  try {
